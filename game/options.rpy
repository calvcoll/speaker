...
init -1 python hide:
    ...
    config.window_title = u"The Speaker Project"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "The Speaker Project"
    config.version = "0.0"
    ...
    style.default.font = "aparajita.ttf"
...
python early:
    config.save_directory = "The Speaker Project-1402868461"
